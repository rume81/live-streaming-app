...
public class Const {
	...
	public static  final  String STREAMING_AND_CHAT_SERVER_ADDRESS = "153.126.152.115";  //"123.200.14.11";
	...
	public static  final  String RED5_SDK_LICENSE =  "O3DC-S7LP-LLB7-3FJU";  // old sdk: "V7LO-IB5B-MTFO-WVZE";
	...
	public static  final  String CHAT_SERVER_SERVICE_NAME = "153.126.152.115";  // "webhawksit";
